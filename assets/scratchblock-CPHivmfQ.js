import{O as P}from"./embellissements-BYV7mIDn.js";function I(w){const v=/[\\{}]/,B=/[{ ]/,y=function(s){let n;return s[0]==="}"?"}":(n=s.split(B)[0],n)},l=function(s,n,a){let t=[],r=[],e=[],f=[],i,b,h,u,$;const D=s.substring(n),k=y(D);switch(k.substring(0,5)){case"\\bloc":switch(b=k.split("{")[0],i=b.length,b=b.substring(6),a++,b){case"stop":r=l(s,n+i+1,a),e=l(s,r[1],r[2]),t=[`${r[0]} ${e[0]} `,e[1],e[2]];break;case"look":r=l(s,n+i+1,a),t=[r[0],r[1],r[2]];break;case"move":r=l(s,n+i+1,a),t=[r[0],r[1],r[2]];break;case"variable":r=l(s,n+i+1,a),t=[r[0],r[1],r[2]];break;case"control":r=l(s,n+i+1,a),t=[r[0],r[1],r[2]];break;case"pen":r=l(s,n+i+1,a),t=[r[0]+" :: pen",r[1],r[2]];break;case"list":r=l(s,n+i+1,a),t=[r[0]+" :: list",r[1],r[2]];break;case"init":r=l(s,n+i+1,a),t=[r[0],r[1],r[2]];break;case`space
`:a--,t=[`
`,11+n,a];break;case"if":for(r=l(s,n+i+1,a),e=l(s,r[1],r[2]),f=l(s,e[1],e[2]),t=[`${r[0]} ${e[0]} ${f[0]}`,f[1]+1,f[2]-1],a=t[2],u=a+1,$=s.substring(t[1]).indexOf("{")+t[1],t[1]=$+1,t[0]+=`
`;u>a;)r=l(s,t[1],u),t[0]+=" "+r[0],t[1]=r[1],u=r[2];t[0]+=" fin";break;case"ifelse":for(r=l(s,n+i+1,a),e=l(s,r[1],r[2]),f=l(s,e[1],e[2]),t=[`${r[0]} ${e[0]} ${f[0]}`,f[1]+1,f[2]-1],a=t[2],u=a+1,$=s.substring(t[1]).indexOf("{")+t[1],t[1]=$+1,t[0]+=`
`;u>a;)r=l(s,t[1],u),t[0]+=" "+r[0],t[1]=r[1],u=r[2];for(t[0]+=" sinon",u=a+1,$=s.substring(t[1]).indexOf("{")+t[1],t[1]=$+1,t[0]+=`
`;u>a;)r=l(s,t[1],u),t[0]+=" "+r[0],t[1]=r[1],u=r[2];t[0]+=" fin";break;case"repeat":for(r=l(s,n+i+1,a),r[0].split(" ")[1]!=="indéfiniment"?r[0].split(" ")[1]!=="jusqu'à"?(e=l(s,r[1],r[2]),f=l(s,e[1],e[2]),t=[`${r[0]} ${e[0]} ${f[0]}`,f[1]+1,f[2]-1],a=t[2]):(e=l(s,r[1],r[2]),t=[`${r[0]} ${e[0]} `,e[1]+1,e[2]-1],a=t[2]):(t=[`${r[0]} `,r[1]+1,r[2]-1],a=t[2]),u=a+1,$=s.substring(t[1]).indexOf("{")+t[1],t[1]=$+1,t[0]+=`
`;u>a;)r=l(s,t[1],u),t[0]+=" "+r[0],t[1]=r[1],u=r[2];t[0]+=" fin";break;default:r=l(s,n+i+1,a),t=[r[0],r[1],r[2]];break}break;case"\\oval":switch(b=k.split("{")[0],i=b.length,b=b.substring(5),a++,b.charAt(b.length-1)==="*"?(h=!0,b=b.substring(0,b.length-1)):h=!1,b){case"num":r=l(s,n+i+1,a),t=[`[${r[0]}]`,r[1]+1,r[2]-1];break;case"moreblocks":r=l(s,n+i+1,a),h?t=[`(${r[0]} v)`,r[1],r[2]]:t=[`(${r[0]})`,r[1],r[2]];break;case"variable":r=l(s,n+i+1,a),h?t=[`(${r[0]} v)`,r[1]+1,r[2]-1]:t=[`(${r[0]})`,r[1]+1,r[2]-1];break;case"sound":r=l(s,n+i+1,a),h?t=[`(${r[0]} v :: sound)`,r[1]+1,r[2]-1]:t=[`(${r[0]} :: sound)`,r[1]+1,r[2]-1];break;case"sensing":r=l(s,n+i+1,a),h?t=[`(${r[0]} v :: sensing)`,r[1]+1,r[2]-1]:t=[`(${r[0]} :: sensing)`,r[1]+1,r[2]-1];break;case"operator":for(r=l(s,n+i+1,a),e=l(s,r[1],r[2]),t=[`(${r[0]} ${e[0]}`,e[1],e[2]];s.charAt(e[1])!=="}";)e=l(s,e[1],e[2]),t[0]+=" "+e[0];t[0]+=")",t[1]=e[1]+1,t[2]=e[2]-1;break;default:r=l(s,n+i+1,a),h?t=[`(${r[0]} v)`,r[1]+1,r[2]-1]:t=[`(${r[0]})`,r[1]+1,r[2]-1];break}break;case"\\bool":switch(b=k.split(/\{ /)[0],i=b.length,b=b.substring(5,9),b){case"oper":for(a++,r=l(s,n+i+1,a),e=l(s,r[1],r[2]),t=[`<${r[0]} ${e[0]}`,e[1],e[2]];s.charAt(e[1])!=="}";)e=l(s,e[1],e[2]),t[0]+=" "+e[0];t[0]+=" :: operators boolean>",t[1]=e[1]+1,t[2]=e[2]-1;break;case"empt":t=["< vide :: operators boolean>",n+i+1,a];break;case"sens":for(a++,r=l(s,n+i+1,a),e=l(s,r[1],r[2]),t=[`<${r[0]} ${e[0]}`,e[1],e[2]];s.charAt(e[1])!=="}";)e=l(s,e[1],e[2]),t[0]+=" "+e[0];t[0]+=" :: sensing>",t[1]=e[1]+1,t[2]=e[2]-1;break;case"list":for(a++,r=l(s,n+i+1,a),e=l(s,r[1],r[2]),t=[`<${r[0]} ${e[0]}`,e[1],e[2]];s.charAt(e[1])!=="}";)e=l(s,e[1],e[2]),t[0]+=" "+e[0];t[0]+=" :: list>",t[1]=e[1]+1,t[2]=e[2]-1;break;default:r=l(s,n+i+1,a),t=[`<${r[0]}>`,r[1],r[2]];break}break;case"\\init":b=k.split("{")[0],i=b.length,a++,r=l(s,n+i+1,a),e=l(s,r[1],r[2]),t=[`${r[0]} ${e[0]} `,e[1],e[2]];break;case"\\name":for(b=k.split("{")[0],i=b.length,a++,r=l(s,n+i+1,a),e=l(s,r[1],r[2]),t=[`${r[0]} ${e[0]}`,e[1],e[2]];s.charAt(e[1])!=="}";)e=l(s,e[1],e[2]),t[0]+=" "+e[0];t[1]=e[1]+1,t[2]=e[2]-1;break;default:switch(k){case"}":a--,t=[" ",1+n,a];break;case"\\begin":{a++,s.substring(15+n)[0]==="["?n=s.substring(15+n).indexOf("]")+16+n:n+=15,t=[" <!-- Code Scratch -->",n,a];break}case"\\end":a--,t=[` <!-- Fin du Code Scratch  -->
`,13+n,a];break;case"\\turnleft":t=["gauche ",11+n,a];break;case"\\turnright":t=["droite ",12+n,a];break;case"\\greenflag":t=[" @greenFlag ",10+n,a];break;case"\\selectmenu":a++,r=l(s,12+n,a),t=[`[${r[0]} v]`,r[1]+1,r[2]-1];break;case"\\selectmenu*":a++,r=l(s,13+n,a),t=[`[${r[0]} v] `,r[1]+1,r[2]-1];break;default:b=s.substring(n).split(v)[0],t=[b,b.length+n,a];break}break}return t};let g="",o,O=[],M,c=0;if((w.match(/\{/g)||[]).length!==(w.match(/\}/g)||[]).length)return!1;{const s=/scale=([\d.]+)/,n=w.match(s);n?g=`<pre class='blocks2' ${n[0]}>`:g="<pre class='blocks'>",M=0,o=!1;let a=0;for(;!o&&a<300;)O=l(w,M,c),g+=O[0],M=O[1],c=O[2],c===0&&(o=!0),a++;o||window.notify("Il y a un problème avec le scratchblock, une commande certainement non gérée : ",{stringLatex:w}),g+=`</pre>
`}return g}class S extends P{constructor(){super(),this.bordures=[-6,-6,6,6]}svg(v){function B(){let g=`<g>
`;for(let o=0;o<360;o+=15)g+=`<line x1="${115+Math.round(45*Math.cos(o*Math.PI/180))}" y1="${115+Math.round(45*Math.sin(o*Math.PI/180))}" x2="${115+Math.round(35*Math.cos(o*Math.PI/180))}" y2="${115+Math.round(35*Math.sin(o*Math.PI/180))}" stroke="white" />
`;return g+`</g>
`}function y(g){return`<g id="sorientera${g}" style="transform: scale(0.675)">
...
<path class="sb3-motion" d="M 0 4
      ...
      <text class="sb3-label sb3-literal-number" x="0" y="13" transform="translate(11 9)">${g}</text>
      </g>
      </g>
      </g>
...
<clipPath id="monClip">
 ...
 <use href="#direction" transform="rotate(90 115 165)" x="115" y="165" />
  <g transform="translate(65 0)">${y(0)}</g>
<g transform="translate(230 65) rotate(90)">${y(90)}</g>
<g transform="translate(165 230) rotate(180)">${y(180)}</g>
<g transform="translate(0 165) rotate(-90)">${y(-90)}</g>
</g>
`}tikz(){return`\\node (centre) {
      ...
      \\begin{scratch}[scale=0.5]
        ...
        \\node[above,rotate=90] at (centre.west){
          \\begin{scratch}[scale=0.5]
                \\blockmove{s'orienter à \\ovalnum{$-90$}}
            \\end{scratch}
            };`}}function z(){return new S}export{z as r,I as s};
